...
#print(df.info())
#exit(0)
#df['Revenue'] = df['Revenue'].apply(lambda x: math.log(x))
...
#cols_to_transform = ['Retailer_country', 'Order_method_type', 'Retailer_type', 'Product_type', 'Quarter']
#df_with_dummies = get_dummies(df, columns=cols_to_transform)

# print(df_with_dummies.head(n=10))

# for val in list(df_with_dummies):
#    print(val)


#columns_to_select = ['Revenue'
#    , 'Gross_margin'
#    , 'Retailer_country_Australia'
#    , 'Retailer_country_Austria'
#    , 'Retailer_country_Belgium'
#    , 'Retailer_country_Brazil'
#    , 'Retailer_country_Canada'
#    , 'Retailer_country_China'
#    , 'Retailer_country_Denmark'
#    , 'Retailer_country_Finland'
#    , 'Retailer_country_France'
#    , 'Retailer_country_Germany'
#    , 'Retailer_country_Italy'
#    , 'Retailer_country_Japan'
#    , 'Retailer_country_Korea'
#    , 'Retailer_country_Mexico'
#    , 'Retailer_country_Netherlands'
#    , 'Retailer_country_Singapore'
#    , 'Retailer_country_Spain'
#    , 'Retailer_country_Sweden'
#    , 'Retailer_country_Switzerland'
#    , 'Retailer_country_United Kingdom'
#    , 'Retailer_country_United States'
#    , 'Order_method_type_E-mail'
#    , 'Order_method_type_Fax'
#    , 'Order_method_type_Mail'
#    , 'Order_method_type_Sales visit'
#    , 'Order_method_type_Special'
#    , 'Order_method_type_Telephone'
#    , 'Order_method_type_Web'
#    , 'Retailer_type_Department Store'
#    , 'Retailer_type_Direct Marketing'
#    , 'Retailer_type_Equipment Rental Store'
#    , 'Retailer_type_Eyewear Store'
#    , 'Retailer_type_Golf Shop'
#    , 'Retailer_type_Outdoors Shop'
#    , 'Retailer_type_Sports Store'
#    , 'Retailer_type_Warehouse Store'
#    , 'Product_type_Binoculars'
#    , 'Product_type_Climbing Accessories'
#    , 'Product_type_Cooking Gear'
#    , 'Product_type_Eyewear'
#    , 'Product_type_First Aid'
#    , 'Product_type_Golf Accessories'
#    , 'Product_type_Insect Repellents'
#    , 'Product_type_Irons'
#    , 'Product_type_Knives'
#    , 'Product_type_Lanterns'
#    , 'Product_type_Navigation'
#    , 'Product_type_Packs'
#    , 'Product_type_Putters'
#    , 'Product_type_Rope'
#    , 'Product_type_Safety'
#    , 'Product_type_Sleeping Bags'
#    , 'Product_type_Sunscreen'
#    , 'Product_type_Tents'
#    , 'Product_type_Tools'
#    , 'Product_type_Watches'
#    , 'Product_type_Woods'
#    , 'Quarter_Q12012'
#    , 'Quarter_Q12013'
#    , 'Quarter_Q12014'
...
#    , 'Quantity']
#
#selected_df = df_with_dummies[columns_to_select]
#print(selected_df.head(n=10))
...
#selected_df = selected_df.dropna(subset=['Gross_margin','Revenue','Quantity'])
#drop zeros
#print("count after removing nan", selected_df.count())
#selected_df = selected_df[selected_df['Revenue'] != 0]
#print("count after removing zeros", selected_df.count())
#print(rows_df.head(n=10))

#print("max: ")
#print(selected_df['Revenue'].max)
#print("min: ")
#print(selected_df['Revenue'].min)
# Normalization

#min_max_scaler = preprocessing.MinMaxScaler()
#np_scaled = min_max_scaler.fit_transform(selected_df)
